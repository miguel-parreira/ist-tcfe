...
frq = logspace(-1, 6, 200);

function out = phaser6 (in)
  TxtFile = fopen("data.txt", "r");
  data = dlmread (TxtFile, '\n');
  fclose(TxtFile);
...
xlabel ("log(f) (Hz)");
ylabel ("v6(t) [dB]");
print (f4, "MAG_v6.eps", "-depsc");
>>>>>>> 5c9f0ef464cd737309e4904c9cd67ad5b6cc40e6
=======
plot (t*1000, vs, 'm');
...
>>>>>>> 5a9b9653bde02f4f390befe5fb0a83faaa06a4ff
